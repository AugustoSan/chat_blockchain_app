...
//   bool _isAutoLoginTriggered = false;
...
//     // Esperamos un momento para que los providers carguen sus estados
...
//     // Si no hay sesión pero la wallet está conectada, iniciar login automáticamente
//     if (_reownProvider != null && _reownProvider!.isConnected && !_isAutoLoginTriggered) {
...
//     if (_isAutoLoginTriggered) {
//       // Ya estamos en proceso de login automático, evitar duplicados
//       return;
//     }
//     _isAutoLoginTriggered = true;
